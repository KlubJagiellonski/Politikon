...
window.onload = function () {
    ...
    window.myLine = new Chart(details).Line(chartDetails, {
        responsive: true,
        showScale: false,
    ...
    window.myLine = new Chart(betchart1).Line(lineChartData, {
        responsive: true,
        showScale: false,
        scaleShowLabels: false,
        datasetStrokeWidth: 6,
    ...
    window.myLine = new Chart(betchart2).Line(lineChartData, {
        responsive: true,
        showScale: false,
        scaleShowLabels: false,
        datasetStrokeWidth: 6,
    ...
    window.myLine = new Chart(betchart3).Line(lineChartData, {
        responsive: true,
        showScale: false,
        scaleShowLabels: false,
        datasetStrokeWidth: 6,
