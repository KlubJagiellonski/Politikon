function startIntro() {
    ...
    intro.setOptions({
        ...
        steps: [
            ...
            {
                element: '#betfeed',
                intro: '<h2>Wydarzenia</h2><p>Tutaj znajdziesz wszystkie <span class="green">aktywne</span> <span class="orange">wydarzenia</span> na <span class="orange">POLITIKONIE.</span></p>',
                position: 'top',
            },
            {
                element: '#betfeed .bet',
                intro: '<p>Przez aktywne rozumiemy takie, na których rozstrzygnięcie możesz postawić.</p><p>Wystarczy, że skorzystasz z przycisków <span class="orange">TAK</span> / <span class="green">NIE,</span> bądź <span class="orange">[+]</span> / <span class="green">[-].</span></p>',
                position: 'top'
            },
            {
                element: '#header .tabs',
