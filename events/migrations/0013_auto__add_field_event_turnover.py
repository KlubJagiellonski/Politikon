...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.turnover'
        db.add_column(u'events_event', 'turnover',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.turnover'
        db.delete_column(u'events_event', 'turnover')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'turnover': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
