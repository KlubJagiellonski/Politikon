...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Event', fields ['turnover']
        db.create_index(u'events_event', ['turnover'])


    def backwards(self, orm):
        # Removing index on 'Event', fields ['turnover']
        db.delete_index(u'events_event', ['turnover'])
