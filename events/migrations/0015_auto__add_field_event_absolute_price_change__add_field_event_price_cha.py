...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.absolute_price_change'
        db.add_column(u'events_event', 'absolute_price_change',
                      self.gf('django.db.models.fields.FloatField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Event.price_change'
        db.add_column(u'events_event', 'price_change',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.absolute_price_change'
        db.delete_column(u'events_event', 'absolute_price_change')

        # Deleting field 'Event.price_change'
        db.delete_column(u'events_event', 'price_change')
