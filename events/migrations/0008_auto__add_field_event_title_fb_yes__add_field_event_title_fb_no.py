...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.title_fb_yes'
        db.add_column(u'events_event', 'title_fb_yes',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Event.title_fb_no'
        db.add_column(u'events_event', 'title_fb_no',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.title_fb_yes'
        db.delete_column(u'events_event', 'title_fb_yes')

        # Deleting field 'Event.title_fb_no'
        db.delete_column(u'events_event', 'title_fb_no')
