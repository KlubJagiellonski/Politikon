...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventSnapshot'
        db.create_table(u'events_event_snapshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('snapshot_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='snapshots', on_delete=models.PROTECT, to=orm['events.Event'])),
            ('current_buy_for_price', self.gf('django.db.models.fields.FloatField')(default=50.0)),
            ('current_buy_against_price', self.gf('django.db.models.fields.FloatField')(default=50.0)),
            ('current_sell_for_price', self.gf('django.db.models.fields.FloatField')(default=50.0)),
            ('current_sell_against_price', self.gf('django.db.models.fields.FloatField')(default=50.0)),
            ...
            ('B', self.gf('django.db.models.fields.FloatField')(default=5)),
        ))
        db.send_create_signal(u'events', ['EventSnapshot'])


    def backwards(self, orm):
        # Deleting model 'EventSnapshot'
        db.delete_table(u'events_event_snapshot')
