...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.last_transaction_date'
        db.alter_column(u'events_event', 'last_transaction_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.outcome'
        db.alter_column(u'events_event', 'outcome', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Event.last_transaction_date'
        raise RuntimeError("Cannot reverse this migration. 'Event.last_transaction_date' and its values cannot be restored.")

        # Changing field 'Event.outcome'
        db.alter_column(u'events_event', 'outcome', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
