...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.current_buy_price'
        db.delete_column(u'events_event', 'current_buy_price')

        # Deleting field 'Event.current_sell_price'
        db.delete_column(u'events_event', 'current_sell_price')

        # Adding field 'Event.current_buy_for_price'
        db.add_column(u'events_event', 'current_buy_for_price',
                      self.gf('django.db.models.fields.FloatField')(default=50.0),
                      keep_default=False)

        # Adding field 'Event.current_buy_against_price'
        db.add_column(u'events_event', 'current_buy_against_price',
                      self.gf('django.db.models.fields.FloatField')(default=50.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.current_buy_price'
        db.add_column(u'events_event', 'current_buy_price',
                      self.gf('django.db.models.fields.FloatField')(default=50.0),
                      keep_default=False)

        # Adding field 'Event.current_sell_price'
        db.add_column(u'events_event', 'current_sell_price',
                      self.gf('django.db.models.fields.FloatField')(default=50.0),
                      keep_default=False)

        # Deleting field 'Event.current_buy_for_price'
        db.delete_column(u'events_event', 'current_buy_for_price')

        # Deleting field 'Event.current_buy_against_price'
        db.delete_column(u'events_event', 'current_buy_against_price')
