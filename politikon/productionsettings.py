...
TWITTER_OAUT_TOKEN = os.environ.get("TWITTER_ACCESS_TOKEN")
TWITTER_OAUT_SECRET = os.environ.get("TWITTER_ACCESS_TOKEN_SECRET")

TWITTER_FEED_CONSUMER_PUBLIC_KEY = TWITTER_CONSUMER_KEY
TWITTER_FEED_CONSUMER_SECRET = TWITTER_CONSUMER_SECRET
TWITTER_FEED_OPEN_AUTH_TOKEN = TWITTER_OAUT_TOKEN
TWITTER_FEED_OPEN_AUTH_SECRET = TWITTER_OAUT_SECRET
