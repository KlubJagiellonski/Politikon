...
SOCIAL_AUTH_TWITTER_KEY = os.environ.get("TWITTER_CONSUMER_KEY", "07cM50zfHeEZg2uuN0lkyyC4w")
SOCIAL_AUTH_TWITTER_SECRET = os.environ.get("TWITTER_CONSUMER_SECRET", "NQE2HRp135fn4rQSxvdMdcZ4Ug3HzG8wwhoKGGUjtxbFVk8Id4")
